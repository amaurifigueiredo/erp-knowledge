...
UPLOAD_ARQUIVOS = 'uploads/arquivos'
    ...
    if request.method == "POST":
        ...
        if imagem and imagem.filename != "":
            ...
            imagem.save(os.path.join(
                app.config['UPLOAD_IMAGENS'], nome_imagem))

        if arquivo and arquivo.filename != "":
            nome_arquivo = secure_filename(arquivo.filename)
            arquivo.save(os.path.join(
                app.config['UPLOAD_ARQUIVOS'], nome_arquivo))
...
def editar(id):
    ...
    if request.method == "POST":
        ...
        cursor.execute(
            "SELECT imagem, arquivo FROM conhecimento WHERE id = ?", (id,))
